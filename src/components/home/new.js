                    ...
                    <div className="masonry-grid row">
                        <div className="masonry-grid-item col-sm-12 col-lg-8 g-mb-30">
                            <article className="row align-items-stretch no-gutters u-shadow-v21 u-shadow-v21--hover g-transition-0_3 shad">
                                ...
                                {/*<div class="col-md-6 g-bg-size-cover g-bg-pos-center g-min-height-300 g-rounded-right-5" data-bg-img-src="/public/img/newf.png" style={{backgroundImage: url( /public/img/newf.png ),}}></div>*/}
                                {/*<div class="col-md-6 g-bg-size-cover g-bg-pos-center g-min-height-300 g-rounded-right-5" data-bg-img-src="../../assets/img-temp/400x500/img1.jpg" style={"background-image: url(&quot;../../assets/img-temp/400x500/img1.jpg&quot;);"}></div>*/}
                                <div className="col-md-6 g-bg-size-cover g-bg-pos-center g-min-height-300 g-rounded-right-5 new-image1"></div>
                            </article>
                        </div>
                        <div className="masonry-grid-item col-sm-6 col-lg-4 g-mb-30">
                            <article className="u-shadow-v21 u-shadow-v21--hover g-transition-0_3 shad">
                                <div className="img-fluid w-100 g-rounded-top-5 new-image2" style={{width:400,height:270}}></div>
                        ...
                        <div className="masonry-grid-item col-sm-6 col-lg-4 g-mb-30 clearfix" >
                            <article className="u-shadow-v21 u-shadow-v21--hover g-transition-0_3 shad">
                                <div className="img-fluid w-100 g-rounded-top-5 new-image3" style={{width:400,height:270}}></div>
                                <div className=" g-pa-30 g-rounded-bottom-5">
                                    <ul className=" list-inline g-color-gray-dark-v4 g-font-weight-600 g-font-size-12">
                                        <li className="list-inline-item mr-0">Alex Teseira</li>
                                        <li className="list-inline-item mx-2">&#183;</li>
                        ...
                        <div className="masonry-grid-item col-sm-12 col-lg-8 g-mb-30">
                            <div className="masonry-grid-item col-sm-6 col-lg-6 g-mb-30" style={{}}>
                                <article className=" g-transition-0_3  text-center " style={{backgroundColor:"#DBE8FA",position:"relative",bottom:20}}>
                            ...
                            <article className="row shad align-items-stretch no-gutters u-shadow-v21 u-shadow-v21--hover g-transition-0_3">
                                ...
                                <div className="col-md-6 g-bg-size-cover g-bg-pos-center g-min-height-300 g-rounded-right-5 new-image4" style={{width:500,height:400}}></div>
                            </article>
