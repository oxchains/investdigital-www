            ...
            <section className="container-fluid px-0">
                <div className="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll loaded dzsprx-readyall g-bg-cover g-bg-black-opacity-0_6--after" data-options='{direction: "fromtop", animation_duration: 25, direction: "reverse"}'>
                    ...
                    <div className="text-center g-pos-rel g-z-index-1">
                        {/*<embed src='/public/img/bgVideo.mp4' allowFullScreen='true'  width='100%' height='600'  type='application/x-shockwave-flash'></embed>*/}
                        <video classID={"example_video_1"} className={"video-js vjs-default-skin vjs-big-play-centered "} playsInline="webkit-playsinline" loop="loop" autoPlay="autoPlay" width="100%" height="auto" controls preload="auto" poster="/public/img/bgVideo.mp4" src="/public/img/bgVideo.mp4" data-setup="{example_option:true}" >
