...
class Technology extends Component{
    ...
    render(){
        const listinfo = [
            {src:`${ROOT_URL}public/img/technology2.gif`,title:"预言机服务——可信", title2:"首个EOS预言机服务的可信资产管理", p1:"InvestDigital致力于打造可信资管平台，也成为了EOS预言机服务的首个真实落地场景。InvestDigital通过EOS预言机机制实现链外业务流程和链内智能合约的结合，保障了资产管理数据的真实性和不可篡改以及交易过程可追溯"},
        ...
        return(
            <section id="application" className="g-pt-50">
                <div className="container text-center g-max-width-75" style={{textAlign:'center'}}>
                    <h2 className="g-font-weight-400 nl-home-title g-font-size-24 g-color-white">InvestDigital技术创新 </h2>
                    ...
                    <div className="row no-gutters">
                        <div className="col-sm-6 col-lg-3 application-item">
                            <article className="u-block-hover">
                                ...
                                <div className=" g-pa-20">
                                    <h3 className="text-uppercase g-font-weight-700 g-font-size-14 text-center" >EOS——高效</h3>
                                    <span className="g-font-size-12">首个基于EOS区块链的智能投资协议</span>
                                    <div className="nl-underline-sm g-mb-15 " style={{lineHeight:"0"}}>
                                        <span className="nl-style-sm"></span>
                                    </div>
                                    <p className="g-font-size-default g-font-size-12 mb-0 text-left"><i className="fa fa-circle nl-fa"></i>
                                        InvestDigital是首个基于EOS区块链的加密数字货币智能投资协议。EOS高吞吐率和高效预言机等优良特性，为InvestDigital提供了智能合约高处理能力和低延迟的数据服务。InvestDigital未来可支持百万级别用户、轻松Bug恢复和升级、以及良好的可扩展性。
                                    </p>
                                </div>
                            </article>
                        </div>
