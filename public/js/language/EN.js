const EN = {
    ...
    product_section2_content: "InvestDigital will provide a cryptocurrency investment community which is like an enhanced Twitter to help investors find valuable strategies, and to attract more investors get involved",
    ...
    product_section6_content: "InvestDigital will develop and provide investment portfolios such as ETF, FOF and etc… to fill in the blanks of cryptocurrency financial products",
    ...
    technology_section3_content: "•	InvestDigital will utilize formal verification technology to detect and avert security vulnerabilities of smart contracts. With the methods of model checking and theorem proving, InvestDigital can be able to ensure the correctness and security of smart-contract codes, and can be able to reduce the risk of hacking attacks to the minimum which can keep security of capitals",
    technology_section4_title: "anonymous reputation rating---fair",
