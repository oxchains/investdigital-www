...
const EN = {
    ...
    banner_notice: "The crowd sale phase of InvestDigital has reached hardcap and come to an end, the next step will be completing IDC offering in next 2 weeks    \n" +
    ...
    crowd_funding_desc: "The crowd sale phase of InvestDigital has reached hardcap and come to an end, the next step will be completing IDC offering in next 2 weeks.",
    ...
    crowd_funding_section1_item4:"800,000,000 IDC",
    ...
    crowd_funding_section1_item7:"360,000,000 IDC",
    ...
    description_section1_content:"Answer: InvestDigital will generate 800 million IDCs, 360 million IDCs will be offered by crowd sale, and the hard cap is 24 million USD. We will accept ETH to exchange, and the rate is 1 ETH = 7000 IDCs.",
    description_section2_title:"What is the discount of private sale？",
    description_section2_content:"Answer: Investors participate in private sale can lock investment quota in advance, and the minimum limit is 1000 ETH, and they can get a percentage bonus. For further details about private sale, please contact IDC Official Wechat: InvestDigital, or  please send e-mail to our maibox: info@investdigital.info",
    description_section3_title:"When will the crowds sale start?",
    description_section3_content:"Answer: The crowd sale phase will start on Jan.14th, 2018. And the private sale phase will start from now. Once the capital reached the hardcap, we will stop crowd sale.",
    description_section4_title:"When will you offer coins after private sale?",
    description_section4_content:"Answer: We will offer ERC20 tokens 2 weeks after the crowd sale closes. And after the main net of IDC launches, we will provide exchange channel for holders to exchange their ERC20 tokens for IDC main net coins. ",
